	   ...
	   private static final String The_LOGIC_PART =
	    ...
	    void firstView() {
	        ...
	        try(Scanner scanner = new Scanner(System.in)){
	            ...
	            System.out.println("Please select any of the options 1, 2 or 3");
	            firstView();
	        }
	    }
	    ...
	    void addFileMethod(String filename) throws IOException{
	        ...
	        for (String file: list) {
	            if (filename.equalsIgnoreCase(file)) {
	                System.out.println("File " + filename + " It is already exists at " + myFolder);
	                return;
	            }
	        }
	    ...
	    void deleteFileMethod(String filename) {
	        ...
	        System.out.println("Delete Operation failed. Because File is not found");
	    }
